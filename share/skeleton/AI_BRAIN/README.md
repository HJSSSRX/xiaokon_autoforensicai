...
> ⚠️ **当前模式：复盘模式 (REVIEW)** — FIC2026 已结束（367/600），不再赶时间。详见 `modes/REVIEW_MODE.md`。

> 任何 Cascade / 新 AI agent 打开本项目，**先读这份 README**，再按下面顺序读剩下的。
>
> **核心目的**：即使换一个模型/账号/新 AI agent，只要读完 AI_BRAIN/ 目录，就能无缝接续解题工作。
> 
